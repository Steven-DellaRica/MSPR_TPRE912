...
echo "▶️ 4. Ajout du repo Helm OpenFaaS..."
helm repo add openfaas https://openfaas.github.io/faas-netes/ || true
helm repo update

echo "▶️ 5. Installation d’OpenFaaS avec Helm..."
...
echo "▶️ 6. Déploiement de PostgreSQL..."
...
echo "▶️ 7. Exposition de la gateway OpenFaaS..."
...
echo "▶️ 8. Construction et déploiement des fonctions..."
